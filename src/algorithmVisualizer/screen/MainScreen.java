...
public class MainScreen extends CustomPanel {
	...
	private void createAndDisplayGUI() {
		menuScreen = new Menu(this, new Rectangle(0, 0, this.getBounds().width, this.getBounds().height/10 ));
		
		sortingScreen = new SortingPanel(this, new Rectangle(0, menuScreen.getY() + menuScreen.getHeight(), this.getBounds().width, this.getBounds().height - menuScreen.getHeight()));
		
		sidePanel = new SidePanel(this, new Rectangle(-1 * this.getBounds().width / 4, sortingScreen.getY(), this.getBounds().width / 4, sortingScreen.getHeight()));
	...
	public void startProcess(PROCESS process) {
		...
		case SIDEPANEL_ANIMATION:
			...
			break;
		default:
			System.out.println("Process Start Request Error: " + process + "Undefined Process");
			break;
		}
	}
	...
	public void doneProcess(PROCESS process) {
		...
		case SHUFFLE:
			...
			break;
		default: 
			System.out.println("Process Done Flag Error: " + process + " Undefined Process");
			break;
	...
	public void changeValue(String name, int value) {
		...
		case "SPEED":
			...
			break;
		default:
			System.out.println("Change Value Error: " + name + "Undefined Variable");
			break;
		}

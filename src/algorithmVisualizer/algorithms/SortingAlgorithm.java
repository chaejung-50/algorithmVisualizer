...
public enum SortingAlgorithm {
	...
	*/
	...
	public String get_worst_space_complexity() {
		return worst_space_complexity;
	}
	
	public String get_best_time_complexity() {
		return time_complexity[BEST];
	}
	
	public String get_average_time_complexity() {
		return time_complexity[AVERAGE];
	}
	
	public String get_worst_time_complexity() {
		return time_complexity[WORST];
	}
	
	//
	
	public int get_current_index() {
		return algorithm.get_current_index();
	}
	
	public int get_traversing_index() {
		return algorithm.get_traversing_index();
	}
	
	public int get_selected_index() {
		return algorithm.get_selected_index();
	}
	
	public int get_array_access() {
		return algorithm.get_array_access();
	}
	...
	public void set_speed(long speed) {
		algorithm.set_speed(speed);
	}
	
	public void set_sorting_panel(SortingPanel sorting_panel) {
		algorithm.set_sorting_panel(sorting_panel);
	}

...
public class CustomSlider extends JSlider{
	...
	protected int CUSTOM_SLIDER_WIDTH;
	protected int CUSTOM_SLIDER_HEIGHT;
	...
	public CustomSlider(Rectangle rect, 
						BoundedRangeModel brm, 
						int minor_tick, 
						int major_tick) {
		CUSTOM_SLIDER_WIDTH = rect.width;
		CUSTOM_SLIDER_HEIGHT = rect.height;
		...
		addMouseListener(new MouseAdapter(){
			...
			public void mouseExited(MouseEvent e) {
				Rectangle bounds = new Rectangle(0, 0, CUSTOM_SLIDER_WIDTH, CUSTOM_SLIDER_HEIGHT);
	...
	public Dimension getPreferredSize() {
		return new Dimension(CUSTOM_SLIDER_WIDTH, CUSTOM_SLIDER_HEIGHT);
	}
